...
def main(datasets_dir):
    instance = Format(os.path.join(datasets_dir, 'InfusionPump'))
    instance.transform_artifacts_from_csv(file_name='Requirements_new.csv', save_name='source.csv')
    instance.transform_artifacts_from_csv(file_name='Components_new.csv', save_name='target.csv')
    instance.transform_TL_from_csv(file_name='AnswerMatrix.csv')
    print('InfusionPump OK')
